		...
		<tbody>
			<?php foreach ( $datas->result() as $data ): ?>
				<tr class="text-center">
					...
					<td><?=$data->team_a_score?>  vs  <?=$data->team_b_score?></td>
					...
					<td><a class="btn btn-success"  href='<?=base_url('matches/edit/'.$data->id);?>'>Update</a></td>
					<td><a class="delete btn btn-danger " data-url='<?=base_url('matches/delete/'.$data->id);?>' href='javascript:void(0)' class='delete btn btn-danger btn-sm'>Delete</a></td>
				</tr>
			<?php endforeach;?>
		</tbody>
	</table>
