		...
		<?=form_open('scores/edit/'.$data->id)?>
							...
							<div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="controls">
                                            <input type="text" name="player_id" value="<?=$data->player_id?>" class="form-control "></div><br/>
									</div>	    
									<div class="col-lg-4">
							...
							<div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="controls">
                                            <input type="text" name="team_id" value="<?=$data->team_id?>" class="form-control "></div><br/>
									</div>	    
									<div class="col-lg-4">
